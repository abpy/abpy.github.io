...
<img src="/images/wb_gray.jpg" width=350px style="max-width:none"></div>
</div>
...
##### Density process
The density process uses two seperate luts. The first converts transmittance to density and second lut converts density to linear luminance. It requires 32-bit mode to handle values greater than 1 and less than 0.
